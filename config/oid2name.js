...
module.exports = function oid2name(assertion) {
  Object.getOwnPropertyNames(assertion).forEach(function (attrName) {
    if (oidNameMap[attrName]) {
      assertion[oidNameMap[attrName]] = assertion[attrName];
    }
  });
}
